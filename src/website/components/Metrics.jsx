    ...
    <section className="w-full bg-surface-container-low py-space-md shadow-xl relative z-20 border-y border-outline-variant/20">
      <div className="max-w-[1440px] mx-auto px-margin-mobile md:px-margin">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-space-md gap-x-space-sm divide-y-0 md:divide-y-0">
          <div className="p-space-sm flex flex-col justify-center items-center text-center">
            ...
            <span className="font-label-uppercase text-label-uppercase tracking-wider text-on-surface-variant font-medium mt-1 text-[11px] text-center">
              {stat1Lbl}
            </span>
          </div>

          <div className="p-space-sm flex flex-col justify-center items-center text-center">
            <div className="flex items-baseline justify-center gap-1 text-secondary">
          ...
          <div className="p-space-sm flex flex-col justify-center items-center text-center bg-surface-container-high/40 rounded-lg">
            <div className="flex items-baseline justify-center gap-1 text-primary-container">
